<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/wtc-references-data';
	import type { Author } from '$lib/data/wtc-references-data';
	...
	const fieldColors: Record<string, string> = {
		'Black Feminist Theory / Cultural Criticism': '#f472b6',
		'Family Therapy / Men\'s Psychology': '#8b5cf6',
		'Family Therapy': '#8b5cf6',
		'Psychotherapy / Pop Psychology': '#a78bfa',
		'Psychoanalysis / Social Theory': '#6366f1',
		'Psychology / Self-Esteem': '#a78bfa',
		'Clinical Psychology': '#14b8a6',
		'Clinical Psychology / Men\'s Studies': '#14b8a6',
		'Clinical Psychology / Criminology': '#ef4444',
		'Feminist Theory / Nonviolence': '#ec4899',
		'Radical Feminist Theory': '#ec4899',
		'Feminist Theory': '#ec4899',
		'Feminist Psychology': '#ec4899',
		'Feminist Psychoanalysis': '#ec4899',
		'Feminist Poetry / Theory': '#ec4899',
		'Feminist Writing': '#ec4899',
		'Black Gay Literature': '#f472b6',
		'Literature / Cultural Criticism': '#f472b6',
		'Literature / Womanism': '#f472b6',
		'Literature / Men\'s Studies': '#6366f1',
		'Literature / Memoir': '#a78bfa',
		'Cultural Criticism / Social History': '#d946ef',
		'Journalism / Feminist Writing': '#f59e0b',
		'Journalism': '#f59e0b',
		'Sociology of Masculinity': '#a78bfa',
		'Sociology / Philosophy': '#6366f1',
		'Men\'s Movement / Philosophy': '#f59e0b',
		'Mythopoetic Men\'s Movement / Poetry': '#dc2626',
		'Men\'s Rights': '#dc2626',
		'Pop Psychology / Men\'s Movement': '#f59e0b',
		'Profeminist Men\'s Activism': '#22c55e',
		'Men\'s Studies / Peace Activism': '#22c55e',
		'Men\'s Liberation / Counseling': '#22c55e',
		'Men\'s Writing / Autobiography': '#6366f1',
		'Media Studies / Anti-Porn Feminism': '#dc2626',
		'Sexuality Research': '#ec4899',
		'Spiritual Self-Help': '#a78bfa',
		'Spiritual Writing / Theology': '#a78bfa',
		'Buddhist Philosophy': '#06b6d4',
		'Zen Buddhism / Peace Activism': '#06b6d4',
		'Christian Peace Activism / Poetry': '#06b6d4',
		'Jewish Theology / Popular Writing': '#06b6d4',
		'Archetypal Psychology': '#a78bfa',
		'Soul / Spirituality': '#a78bfa',
		'Anti-Feminist Philosophy': '#dc2626',
		'Cardiology / Lifestyle Medicine': '#14b8a6',
		'Philosophy / Feminist Theory': '#ec4899',
		'Poetry / Agrarianism': '#84cc16',
		'Therapy / Black Men\'s Recovery': '#f472b6',
		'Social Work': '#14b8a6',
		'Cultural History / Partnership Theory': '#d946ef',
		'Psychology': '#a78bfa',
		'Developmental Psychology': '#10b981',
		'Gay Studies': '#22c55e',
		'Memoir': '#a78bfa'
	};
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				<a href="/will-to-change" class="back-link">&larr; Buchübersicht</a>
				<a href="/will-to-change/evidence" class="back-link">Evidenz-Audit</a>
			</div>
...
<style>
	...
	.stat-value { display: block; font-size: 1.8rem; font-weight: 800; color: #f472b6; }
	...
	.search-bar input:focus { border-color: #f472b6; }
	...
	.field-btn.active { background: var(--field-color, #f472b6); color: white; border-color: transparent; }
	...
	.author-card.key-figure { border-left: 3px solid #f472b6; }
	.author-card.expanded { border-color: rgba(244, 114, 182, 0.4); }
	...
	.star { color: #f472b6; font-size: 1rem; }
	...
	.inst-card {
		background: rgba(30, 41, 59, 0.6); border-radius: 10px; padding: 18px;
		border: 1px solid rgba(148, 163, 184, 0.12); border-left: 3px solid #f472b6;
	}
