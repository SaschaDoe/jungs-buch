<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/nbm-references-data';
	import type { Author } from '$lib/data/nbm-references-data';
	...
	const fieldColors: Record<string, string> = {
		'Business / Media': '#f59e0b',
		'Policy / Brookings / AIBM': '#10b981',
		'Evolutionary Biology / Endocrinology': '#0ea5e9',
		'Pop-Neuroscience (kritisiert)': '#ef4444',
		'Sexology (retracted)': '#ef4444',
		'Social Psychology': '#8b5cf6',
		'Economics / Social Mobility': '#0ea5e9',
		'Psychology / Public Health': '#14b8a6',
		'Survey Research': '#84cc16',
		'Developmental Neuroscience': '#0ea5e9',
		'Clinical Psychology / Porn Research': '#14b8a6',
		'Communication Science': '#84cc16',
		'Psychiatry / Addiction': '#14b8a6',
		'Psychology / Generational Research': '#8b5cf6',
		'Relationship Research': '#ec4899',
		'Family Sociology (advokatorisch)': '#f97316',
		'Developmental Psychobiology': '#0ea5e9',
		'Masculinity Writing': '#d946ef',
		'Developmental Psychology': '#14b8a6',
		'Neuroscience': '#0ea5e9',
		'Media / Tech Analysis': '#f59e0b',
		'Neuroscience / Podcast': '#f59e0b',
		'Pediatrics': '#10b981'
	};
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				...
				<a href="/notes-on-being-a-man/evidence" class="back-link">Evidenz-Audit</a>
			</div>
