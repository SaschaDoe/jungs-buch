<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/rb-references-data';
	import type { Author } from '$lib/data/rb-references-data';
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				...
				<a href="/real-boys/evidence" class="back-link">Evidenz-Audit</a>
				<a href="/real-boys/reading" class="back-link">Weiterführende Literatur &rarr;</a>
			</div>
