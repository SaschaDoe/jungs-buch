<svelte:head>
	<title>Raising Cain — Buchanalyse</title>
...
<div class="app">
	<header class="hero">
		...
		<h1>Raising Cain</h1>
		<p class="subtitle">Protecting the Emotional Life of Boys</p>
		<p class="author">Dan Kindlon, Ph.D. &amp; Michael Thompson, Ph.D.</p>
		<p class="description">
	...
	<main class="cards">
		<a href="/raising-cain/evidence" class="card card-evidence">
		...
		<a href="/raising-cain/references" class="card card-refs">
			<div class="card-icon">&#128218;</div>
			<div class="card-content">
	...
	<footer class="app-footer">
		<p>Interaktive Analyse zu: <em>Raising Cain</em></p>
	</footer>
</div>
