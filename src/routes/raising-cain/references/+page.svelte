<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/rc-references-data';
	import type { Author } from '$lib/data/rc-references-data';
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				...
				<a href="/raising-cain/evidence" class="back-link">Evidenz-Audit</a>
				<a href="/raising-cain/reading" class="back-link">Weiterführende Literatur &rarr;</a>
			</div>
...
<style>
	...
	.field-btn.active {
		background: var(--field-color, #14b8a6);
		color: white;
		border-color: transparent;
	}
