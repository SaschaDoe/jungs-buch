<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/gm-references-data';
	import type { Author } from '$lib/data/gm-references-data';
	...
	const fieldColors: Record<string, string> = {
		'Sociology of Gender': '#a78bfa',
		'Sociology': '#8b5cf6',
		'Sociology / Criminology': '#7c3aed',
		'Sociology of Sport': '#f59e0b',
		'Sociology of Work': '#f97316',
		'Sociology of Work and Technology': '#f97316',
		'Sociology of Education': '#10b981',
		'Sociology of Health': '#14b8a6',
		'Sociology of Religion': '#06b6d4',
		'Sociology of Emotion': '#ef4444',
		'Sociology / Critical Studies on Men': '#a78bfa',
		'Sociology / Feminist Theory': '#ec4899',
		'Sociology / Gay Studies': '#22c55e',
		'Sociology / Philosophy': '#6366f1',
		'Sociology / Men\'s Studies': '#a78bfa',
		'Cultural Anthropology': '#84cc16',
		'Cultural Studies': '#d946ef',
		'Political Theory': '#ef4444',
		'Political Theory / Gender Studies': '#f43f5e',
		'Political Philosophy': '#ef4444',
		'Political Philosophy / Feminist Theory': '#ec4899',
		'Psychoanalysis': '#fb7185',
		'Psychoanalysis / Marxism': '#f43f5e',
		'Frankfurt School': '#dc2626',
		'Frankfurt School / Psychoanalysis': '#dc2626',
		'Existentialist Philosophy / Feminism': '#ec4899',
		'Existentialism / Marxism': '#dc2626',
		'Structuralist Psychoanalysis': '#fb7185',
		'Feminist Psychoanalysis': '#ec4899',
		'Feminist Theory': '#f472b6',
		'Feminist Theory / Psychoanalysis': '#f472b6',
		'Feminist Theory / Psychology': '#f472b6',
		'Feminist Anthropology': '#84cc16',
		'History': '#78716c',
		'History of Education': '#10b981',
		'History of Science': '#0ea5e9',
		'Endocrinology': '#f43f5e',
		'Sociobiology': '#dc2626',
		'Anthropology / Sociobiology': '#dc2626',
		'Education / Discourse Analysis': '#ec4899',
		'Mythopoetic Men\'s Movement': '#dc2626',
		'Men\'s Rights Activism': '#dc2626',
		'Pop Psychology / Men\'s Movement': '#f59e0b',
		'Men\'s Movement': '#f59e0b',
		'Profeminist Men\'s Activism': '#22c55e',
		'Profeminist Men\'s Activism / Social Work': '#22c55e',
		'Jungian Psychotherapy': '#a16207',
		'International Relations / Gender Studies': '#0ea5e9',
		'Military Theory': '#dc2626',
		'Translation': '#64748b',
		'Gay Liberation Theory': '#22c55e',
		'Cultural Critique / Sociology': '#d946ef',
		'Philosophy / History': '#a78bfa'
	};
...
<div class="app">
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				<a href="/der-gemachte-mann" class="back-link">&larr; Buchübersicht</a>
				<a href="/der-gemachte-mann/evidence" class="back-link">Evidenz-Audit</a>
			</div>
	...
	<section class="section">
		...
		<p class="section-intro">Diese Forscher:innen bilden das theoretische Fundament des Buches und werden wiederholt zitiert.</p>
...
<style>
	...
	.stat-value { display: block; font-size: 1.8rem; font-weight: 800; color: #a78bfa; }
	...
	.field-btn.active { background: var(--field-color, #a78bfa); color: white; border-color: transparent; }
	...
	.author-card.key-figure { border-left: 3px solid #a78bfa; }
	.author-card.expanded { border-color: rgba(167, 139, 250, 0.4); }
	...
	.star { color: #a78bfa; font-size: 1rem; }
	...
	.inst-card {
		background: rgba(30, 41, 59, 0.6); border-radius: 10px; padding: 18px;
		border: 1px solid rgba(148, 163, 184, 0.12); border-left: 3px solid #a78bfa;
	}
