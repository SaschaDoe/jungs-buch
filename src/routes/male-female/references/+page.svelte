<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/mf-references-data';
	import type { Author } from '$lib/data/mf-references-data';
	...
	const fieldColors: Record<string, string> = {
		...
		Evolutionsbiologie: '#15803d',
		Verhaltensgenetik: '#7c3aed',
		Kognitionswissenschaft: '#0891b2'
	};
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				...
				<a href="/male-female/evidence" class="back-link">Evidenz-Audit</a>
				<a href="/male-female/reading" class="back-link">Weiterführende Literatur &rarr;</a>
			</div>
...
<style>
	...
	.field-btn.active {
		background: var(--field-color, #6366f1);
		color: white;
		border-color: transparent;
	}
