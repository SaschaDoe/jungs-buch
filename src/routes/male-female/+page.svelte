<svelte:head>
	<title>Male, Female — Buchanalyse</title>
...
<div class="app">
	<header class="hero">
		...
		<h1>Male, Female</h1>
		<p class="subtitle">The Evolution of Human Sex Differences</p>
		<p class="author">David C. Geary, Ph.D.</p>
		<p class="description">
			Dieses akademische Lehrbuch wird hier mit interaktiven Datenvisualisierungen,
			Quellenanalysen und weiterführenden Perspektiven begleitet.
		</p>
	</header>

	<main class="cards">
		<a href="/male-female/evidence" class="card card-evidence">
		...
		<a href="/male-female/references" class="card card-refs">
			<div class="card-icon">&#128218;</div>
			<div class="card-content">
	...
	<footer class="app-footer">
		<p>Interaktive Analyse zu: <em>Male, Female</em></p>
	</footer>
</div>
...
<style>
	...
	.card-reading { --card-color: #818cf8; }
