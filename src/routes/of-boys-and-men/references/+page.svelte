<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/obm-references-data';
	import type { Author } from '$lib/data/obm-references-data';
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				...
				<a href="/of-boys-and-men/evidence" class="back-link">Evidenz-Audit</a>
			</div>
...
<style>
	...
	.hero h1 {
		...
		background: linear-gradient(135deg, #a7f3d0, #10b981, #059669);
	...
	.field-btn.active { background: var(--field-color, #10b981); color: #1e293b; border-color: transparent; }
	...
	.author-card.key-figure { border-left: 3px solid #10b981; }
	...
	.star { color: #10b981; font-size: 1rem; }
	...
	.inst-card {
		background: rgba(30, 41, 59, 0.6); border-radius: 10px; padding: 18px;
		border: 1px solid rgba(148, 163, 184, 0.12); border-left: 3px solid #10b981;
	}
