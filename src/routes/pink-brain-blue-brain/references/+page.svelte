<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/pb-references-data';
	import type { Author } from '$lib/data/pb-references-data';
	...
	onMount(() => {
		...
		if (urlSearch) {
			...
			activeView = 'authors';
			// Auto-expand first matching author
	...
	const fieldColors: Record<string, string> = {
		...
		Wirtschaft: '#eab308',
		Geschichte: '#78716c',
		Endokrinologie: '#f43f5e',
		Toxikologie: '#0ea5e9',
		Biologie: '#84cc16',
		Epidemiologie: '#d946ef',
		Anthropologie: '#a16207'
	};
...
<div class="app">
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				...
				<a href="/pink-brain-blue-brain/evidence" class="back-link">Evidenz-Audit</a>
				<a href="/pink-brain-blue-brain/reading" class="back-link">Weiterf&uuml;hrende Literatur &rarr;</a>
			</div>
	...
	<div class="stats-bar">
		...
		<div class="stat">
			...
			<span class="stat-label">Schl&uuml;sselfiguren</span>
		</div>
	</div>

	<!-- Key figures -->
	<section class="section">
		<h2>Schl&uuml;sselfiguren des Buches</h2>
...
<style>
	...
	.field-btn:hover {
		border-color: var(--field-color, #94a3b8);
		color: #e2e8f0;
	}
	.field-btn.active {
		background: var(--field-color, #ec4899);
		color: white;
		border-color: transparent;
	}
