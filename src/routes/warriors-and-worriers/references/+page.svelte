<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/ww-references-data';
	import type { Author } from '$lib/data/ww-references-data';
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				...
				<a href="/warriors-and-worriers/evidence" class="back-link">Evidenz-Audit</a>
				<a href="/warriors-and-worriers/reading" class="back-link">Weiterführende Literatur &rarr;</a>
			</div>
...
<style>
	...
	.field-btn.active {
		background: var(--field-color, #ef4444);
		color: white;
		border-color: transparent;
	}
