<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/ds-references-data';
	import type { Author } from '$lib/data/ds-references-data';
	...
	const fieldColors: Record<string, string> = {
		'Developmental Psychology': '#f43f5e',
		'Developmental Psychology / Feminist Theory': '#ec4899',
		'Educational Psychology': '#fb7185',
		'Social Psychology': '#0ea5e9',
		'Psychology (early 20th century)': '#a78bfa',
		'Psychiatrie / Interpersonal Theory': '#14b8a6',
		'Klinische Psychologie': '#14b8a6',
		'Anthropologie': '#84cc16',
		'Gender & Development / Global Health': '#ec4899',
		'Political Science / Social Capital': '#f97316',
		'Neurowissenschaft / Kritik des Biologismus': '#0ea5e9',
		'Sozialpädagogik / Soziologie': '#10b981',
		...
		'Familienforschung': '#059669',
		'Soziologie / Zeitdiagnose': '#059669',
		'Soziologie': '#059669',
		'Philosophie / Geschichte der Sexualität': '#a78bfa',
		'Soziologie / Systemtheorie': '#059669',
		'Soziologie / Familienforschung': '#059669',
		'Sozialpädagogik': '#10b981',
		'Religionssoziologie / Männerforschung': '#059669',
		'Männerforschung': '#10b981',
		...
		'Humanistische Psychologie': '#10b981',
		'Klinische Psychologie / Neuropsychotherapie': '#10b981',
		...
		'Journalismus / Popkultur-Theorie': '#10b981',
		'Journalismus / Porno-Pädagogik': '#10b981',
		'Stand-up Comedy': '#f59e0b',
		'Policy / Brookings': '#10b981',
		'Economics / Social Mobility': '#0ea5e9',
		'Economics / Labor Market': '#0ea5e9',
		'Evolutionary Biology / Human Evolutionary Biology': '#0ea5e9',
		'Cultural Evolution / Evolutionary Anthropology': '#84cc16',
		'Developmental Psychology / Adolescent Development': '#14b8a6',
		'Anthropology / Evolutionary': '#84cc16',
		'Anthropology / Fatherhood Research': '#84cc16',
		'Economics of Education': '#0ea5e9',
		'Economics / Labor Discrimination': '#0ea5e9',
		'Family Sociology': '#10b981',
		'Sociology / Poverty Research': '#10b981',
		'Sociology / Family': '#10b981',
		'Sociology / Race and Gender': '#10b981',
		'Sociology / Gender Studies': '#8b5cf6',
		'Psychology / Neuroscience': '#0ea5e9',
		'Biological Anthropology': '#84cc16',
		'Evolutionary Psychology': '#84cc16',
		'Cognitive Neuroimaging': '#0ea5e9',
		'Philosophy / Black Male Studies': '#8b5cf6',
		'Psychology / Gender Similarities': '#0ea5e9',
		'Economics / Labor History': '#0ea5e9',
		'Historical Demography': '#10b981',
		'Economics / Family Policy': '#10b981',
		'Economics / Public Health': '#14b8a6'
	};
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				...
				<a href="/deep-secrets/evidence" class="back-link">Evidenz-Audit</a>
			</div>
...
<style>
	...
	.stat-value { display: block; font-size: 1.8rem; font-weight: 800; color: #f43f5e; }
	...
	.field-btn.active { background: var(--field-color, #f43f5e); color: #1e293b; border-color: transparent; }
	...
	.author-card.key-figure { border-left: 3px solid #f43f5e; }
	...
	.star { color: #f43f5e; font-size: 1rem; }
	...
	.inst-card {
		background: rgba(30, 41, 59, 0.6); border-radius: 10px; padding: 18px;
		border: 1px solid rgba(148, 163, 184, 0.12); border-left: 3px solid #f43f5e;
	}
	...
	.inst-type {
		font-size: 0.72rem; padding: 2px 8px; border-radius: 12px;
		background: rgba(251, 191, 36, 0.2); color: #a7f3d0;
	}
