<svelte:head>
	<title>Boys Adrift — Buchanalyse</title>
...
<div class="app">
	<header class="hero">
		...
		<h1>Boys Adrift</h1>
		<p class="subtitle">The Five Factors Driving the Growing Epidemic of Unmotivated Boys and Underachieving Young Men</p>
	...
	<main class="cards">
		<a href="/boys-adrift/evidence" class="card card-evidence">
		...
		<a href="/boys-adrift/references" class="card card-refs">
			<div class="card-icon">&#128218;</div>
			<div class="card-content">
	...
	<footer class="app-footer">
		<p>Interaktive Analyse zu: <em>Boys Adrift</em></p>
	</footer>
</div>
...
<style>
	...
	.card-reading { --card-color: #fb923c; }
