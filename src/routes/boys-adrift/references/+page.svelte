<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/ba-references-data';
	import type { Author } from '$lib/data/ba-references-data';
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				...
				<a href="/boys-adrift/evidence" class="back-link">Evidenz-Audit</a>
				<a href="/boys-adrift/reading" class="back-link">Weiterführende Literatur &rarr;</a>
			</div>
...
<style>
	...
	.field-btn.active {
		background: var(--field-color, #f59e0b);
		color: white;
		border-color: transparent;
	}
