<svelte:head>
	<title>Why Gender Matters, Second Edition — Buchanalyse</title>
...
<div class="app">
	<header class="hero">
		...
		<h1>Why Gender Matters</h1>
		<p class="edition">Second Edition</p>
		<p class="subtitle">What Parents and Teachers Need to Know About the Emerging Science of Sex Differences</p>
		<p class="author">Leonard Sax, M.D., Ph.D.</p>
		<p class="description">
	...
	<main class="cards">
		<a href="/why-gender-matters/evidence" class="card card-evidence">
		...
		<a href="/why-gender-matters/references" class="card card-refs">
			<div class="card-icon">&#128218;</div>
			<div class="card-content">
	...
	<footer class="app-footer">
		<p>Interaktive Analyse zu: <em>Why Gender Matters, Second Edition</em></p>
	</footer>
</div>
