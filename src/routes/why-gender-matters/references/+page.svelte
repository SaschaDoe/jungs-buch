<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/wgm-references-data';
	import type { Author } from '$lib/data/wgm-references-data';
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				...
				<a href="/why-gender-matters/evidence" class="back-link">Evidenz-Audit</a>
				<a href="/why-gender-matters/reading" class="back-link">Weiterführende Literatur &rarr;</a>
			</div>
...
<style>
	...
	.field-btn.active {
		background: var(--field-color, #34d399);
		color: white;
		border-color: transparent;
	}
