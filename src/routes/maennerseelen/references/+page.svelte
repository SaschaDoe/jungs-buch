<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/mse-references-data';
	import type { Author } from '$lib/data/mse-references-data';
	...
	const fieldColors: Record<string, string> = {
		'Sozialpädagogik / Soziologie': '#22d3ee',
		...
		'Familienforschung': '#06b6d4',
		'Soziologie / Zeitdiagnose': '#6366f1',
		'Soziologie': '#6366f1',
		'Philosophie / Geschichte der Sexualität': '#a78bfa',
		'Soziologie / Systemtheorie': '#6366f1',
		'Soziologie / Familienforschung': '#06b6d4',
		'Sozialpädagogik': '#22d3ee',
		'Religionssoziologie / Männerforschung': '#06b6d4',
		'Männerforschung': '#22d3ee',
		...
		'Humanistische Psychologie': '#22d3ee',
		'Klinische Psychologie / Neuropsychotherapie': '#22d3ee',
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				...
				<a href="/maennerseelen/evidence" class="back-link">Evidenz-Audit</a>
			</div>
...
<style>
	...
	.stat-value { display: block; font-size: 1.8rem; font-weight: 800; color: #22d3ee; }
	...
	.field-btn.active { background: var(--field-color, #22d3ee); color: #1e293b; border-color: transparent; }
	...
	.author-card.key-figure { border-left: 3px solid #22d3ee; }
	...
	.star { color: #22d3ee; font-size: 1rem; }
	...
	.inst-card {
		background: rgba(30, 41, 59, 0.6); border-radius: 10px; padding: 18px;
		border: 1px solid rgba(148, 163, 184, 0.12); border-left: 3px solid #22d3ee;
	}
	...
	.inst-type {
		font-size: 0.72rem; padding: 2px 8px; border-radius: 12px;
		background: rgba(251, 191, 36, 0.2); color: #a5f3fc;
	}
