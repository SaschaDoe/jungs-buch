<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/pr-references-data';
	import type { Author } from '$lib/data/pr-references-data';
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				...
				<a href="/was-sie-wirklich/evidence" class="back-link">Evidenz-Audit</a>
			</div>
