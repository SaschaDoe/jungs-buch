<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/wb-references-data';
	import type { Author } from '$lib/data/wb-references-data';
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				...
				<a href="/wonder-of-boys/evidence" class="back-link">Evidenz-Audit</a>
				<a href="/wonder-of-boys/reading" class="back-link">Weiterführende Literatur &rarr;</a>
			</div>
...
<style>
	...
	.field-btn.active {
		background: var(--field-color, #06b6d4);
		color: white;
		border-color: transparent;
	}
