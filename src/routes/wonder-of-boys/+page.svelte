<svelte:head>
	<title>The Wonder of Boys — Buchanalyse</title>
...
<div class="app">
	<header class="hero">
		...
		<h1>The Wonder of Boys</h1>
		<p class="subtitle">What Parents, Mentors and Educators Can Do to Shape Boys into Exceptional Men</p>
		<p class="author">Michael Gurian</p>
		<p class="description">
	...
	<main class="cards">
		<a href="/wonder-of-boys/evidence" class="card card-evidence">
		...
		<a href="/wonder-of-boys/references" class="card card-refs">
			<div class="card-icon">&#128218;</div>
			<div class="card-content">
	...
	<footer class="app-footer">
		<p>Interaktive Analyse zu: <em>The Wonder of Boys</em></p>
	</footer>
</div>
...
<style>
	...
	.card-refs { --card-color: #06b6d4; }
	.card-reading { --card-color: #22d3ee; }
