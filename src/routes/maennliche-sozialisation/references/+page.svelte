<script lang="ts">
	import { authors, institutions, studies, categories, bookInfo } from '$lib/data/ms-references-data';
	import type { Author } from '$lib/data/ms-references-data';
	...
	const fieldColors: Record<string, string> = {
		'Sozialpädagogik / Soziologie': '#fbbf24',
		...
		'Sozialpädagogik': '#fbbf24',
		'Religionssoziologie / Männerforschung': '#f59e0b',
		'Männerforschung': '#fbbf24',
	...
	<header class="hero">
		<div class="hero-inner">
			<div style="display:flex;gap:20px;justify-content:center">
				...
				<a href="/maennliche-sozialisation/evidence" class="back-link">Evidenz-Audit</a>
			</div>
...
<style>
	...
	.stat-value { display: block; font-size: 1.8rem; font-weight: 800; color: #fbbf24; }
	...
	.field-btn.active { background: var(--field-color, #fbbf24); color: #1e293b; border-color: transparent; }
	...
	.author-card.key-figure { border-left: 3px solid #fbbf24; }
	...
	.inst-card {
		background: rgba(30, 41, 59, 0.6); border-radius: 10px; padding: 18px;
		border: 1px solid rgba(148, 163, 184, 0.12); border-left: 3px solid #fbbf24;
	}
